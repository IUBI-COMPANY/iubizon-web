...
const steps = [
    {
        title: 'Contacto',
        description: 'Completa el formulario o llámanos. Respuesta garantizada en menos de 24 horas.',
        icon: Phone,
    ...
    {
        title: 'Diagnóstico',
        description: 'Revisión técnica completa de tu proyector por especialistas certificados.',
        icon: Shield,
    ...
    {
        title: 'Reparación',
        description: 'Reparación con repuestos originales certificados y 3 meses de garantía incluida.',
        icon: Wrench,
    ...
    {
        title: 'Entrega',
        description: 'Recibe tu proyector funcionando perfectamente a domicilio en Lima con garantía completa.',
        icon: CheckCircle,
